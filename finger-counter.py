...
firebase = firebase.FirebaseApplication('https://xxx-yyy-zzz.firebaseio.com', None)
count = 0

def getNumber(dataInput):
    numberInput = dataInput[10:]
    number = string2Number(numberInput)
    return number
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        firebase.put('/','gesture',getNumber(gesture))

        if cv2.waitKey(5) & 0xFF == 27:
            print(cv2.waitKey(5) & 0xFF)
            break
